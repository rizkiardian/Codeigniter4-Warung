...
<div class="px-20 py-10 m-auto">
    <div class="p-5 m-auto w-[40rem] shadow-lg border-2 border-black/10 rounded-2xl">
        <div>
            <h1 class="text-2xl text-center font-bold uppercase">Tambah Makanan</h1>
        </div>
        <div>
            <form action="<?= base_url('CrudMakananController/formtambahproses') ?>" method="POST" enctype="multipart/form-data">
                <div class="mt-5 grid gap-x-8 gap-y-4">
                    <div>
                        ...
                        <?php endif; ?>
                        <input type="text" name="nama_makanan" placeholder="masukkan nama makanan" class="focus:outline-0 mt-2 border-2 border-[#27ae60]/50 h-11 w-full pl-3 rounded-lg">
                    </div>
                    <div>
